      ...
      <div class="container extended-form mx-auto">
        <div class="row">
          ...
          <div class="col-md-10">
            ...
            <form action="controladores/procesar.php" class="formula" method="post" id="formula" onsubmit="return ValidarFormula()">
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group mb-3" id="group_Num">  
                      ...
                      <div class="formulario_group-input">
                        <input  class="form-control" type="number" name="Num" id="Num" placeholder="Ingrese su Número de calle" required>
                        <i class="formulario_validacion-estado fa-solid fa-circle-xmark"></i>
                      </div>
                    ...
                    <div class="form-group mb-3" id="group_CP">
                      ...
                      <div class="formulario_group-input">
                        <input  class="form-control" type="number" name="CP" id="CP" max="99999" min="00001"  placeholder="Coloque su C.P" required>
                        <i class="formulario_validacion-estado fa-solid fa-circle-xmark"></i>
                      </div>
                    ...
                    <div class="form-group" id="group_telefono">
                      ...
                      <div class="formulario_group-input">
                        <input class="form-control" type="tel" name="telefono" id="telefono" placeholder="Ingrese su No.Teléfono" required >
                        <i class="formulario_validacion-estado fa-solid fa-circle-xmark"></i>
                      </div>
                    ...
                    <div class="form-group mb-3" id="group_Promedio">
                        ...
                        <div class="formulario_group-input">
                          <input type="number" step="0.01" class="form-control" id="Promedio" name="Promedio" placeholder="Ingrese su Promedio" required>
                          <i class="formulario_validacion-estado fa-solid fa-circle-xmark"></i>
                        </div>
